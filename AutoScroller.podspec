#
#  Be sure to run `pod spec lint AutoScroller.podspec' to ensure this is a
...
Display custom "scroll to top" or "scroll to bottom" views in to all UIScrollView instances while they are scrolling.
  ...
  s.homepage     = "https://github.com/cemolcay/AutoScroller"
  ...
  s.source       = { :git => "https://github.com/cemolcay/AutoScroller.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "AutoScroller/AutoScroller.swift"
